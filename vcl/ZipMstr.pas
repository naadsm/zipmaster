...
(* TZipMaster VCL by Chris Vleghert and Eric W. Engler
 ...
 v1.78 by Russell Peters April 26, 2005.
...
type
  ...
  TProgressSize = ZipProg.TProgressSize;
...
begin
  ...
  if CanStart then
    try
      Starting;
      Result := FZip.Load_Unz_Dll(silent);
    finally
      Done;
    end;
end;
...
begin
  ...
  if CanStart then
    try
      Starting;
      Result := FZip.Load_Zip_Dll(silent);
    finally
      Done;
    end;
end;
