...
extern void user_callback( struct Globals * pG, long action, long error_code, unsigned long fsize, char * name_or_msg );
...
extern void __cdecl MyDiag( struct Globals * pG, const char *,... );
...
typedef struct _UzpInit
{
  ...
  * does it matter? add "far" keyword to make sure? */
  ...
  void( * userfn ) ();
  /* user init function to be called after globals */
