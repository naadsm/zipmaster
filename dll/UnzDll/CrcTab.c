...
*
* $Id: CrcTab.c,v 1.1 2006-02-27 19:14:37 areeves Exp $
*
...
error:
Dynamic allocation of CRC table not safe with reentrant code.
...
static void make_crc_table()
{
  ...
  ulg * crctab_p;
  /* temporary pointer to allocated crc_table area */
    #else /* !DYNALLOC_CRCTAB */
  ...
  * supply the resultant pattern at compile time. */
  ...
  MemDiag1( crctab_p, 256 * sizeof( ulg ), __LINE__, __FILE__ );
  if ( crctab_p == NULL )
  {
    ziperr( UEN_MEM02, "crc_table allocation" );
  }
    #endif /* DYNALLOC_CRCTAB */
