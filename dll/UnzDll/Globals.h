...
HANDLE    /*int*/ zipfdz;                    /* zipfile file handle */

POSN   /* long*/ ziplen;
POSN   /* long*/ cur_zipfile_bufstart;    /* extract_or_test, readbuf, ReadByte */
...
//    char *ExtractDir;             /* v1.6024 */
    ...
    int NewCB;                  // 1.77 true = use new callbacks
    int CallerVersion;
...
#define GA_ERROR 1             // handling error
#define GA_CANCEL 2            // callback signalled cancel
#define GA_EXCEPT 4            // callback caused exception
#define GA_ABORT 8             // Exec(nul) Abort requested
/***************************************************************************/
