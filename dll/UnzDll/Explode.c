...
/* routines here */
static int get_tree( struct Globals * pG, unsigned * l, unsigned n );
static int explode_lit8( struct Globals * pG, struct huft * tb, struct huft * tl, struct huft * td, int bb, int bl, int bd );
static int explode_lit4( struct Globals * pG, struct huft * tb, struct huft * tl, struct huft * td, int bb, int bl, int bd );
static int explode_nolit8( struct Globals * pG, struct huft * tl, struct huft * td, int bl, int bd );
static int explode_nolit4( struct Globals * pG, struct huft * tl, struct huft * td, int bl, int bd );
int explode( struct Globals * pG );
