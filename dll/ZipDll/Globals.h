 ...
 *  Globals.h from UnzipDll version 1.60 and
...
struct Globals
{
    ...
    // RCV Changed/Added 29-1-99   Removed: FILE *zipfd
...
extern DWORD TgbIndex;
    #define GlobalPointer TlsGetValue( TgbIndex )
  #else
extern struct Globals *pGsav;
    #define GlobalPointer pGsav
  #endif
  #ifdef DYNAMIC_CRC_TABLE
error Must use static CRC table
  #endif

//#define CRC_32_TAB  pG->crc_32_tab
  #define CRC_32_TAB  crc_table
 ...
 */
  #define case_map( c ) upper[( ( unsigned char )c ) /* & 0xFF*/ ]
  #define to_up( c )    upper[( ( unsigned char )c ) /* & 0xFF*/ ]
